...
public class UsuarioController {
	...
	@CacheEvict(value = "listusuarios", allEntries = true)
	@CachePut("listusuarios")
	...
	public ResponseEntity<Usuario> atualizar(@RequestBody Usuario usuario) {
		...
		Optional<Usuario> usertemp = usuarioRepository.findById(usuario.getId());

		if (!usertemp.get().getSenha().equals(usuario.getSenha())) {
			String senhacrip = new BCryptPasswordEncoder().encode(usuario.getSenha());
			usuario.setSenha(senhacrip);
		}
